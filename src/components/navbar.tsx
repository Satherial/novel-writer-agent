              ...
              <>
                ...
                <div className="relative inline-flex">
                  <button
                    ...
                    id="user-dropdown"
                    data-hs-dropdown="#user-dropdown-menu"
                    aria-haspopup="menu"
                    aria-expanded="false"
                  >
                  ...
                  <div
                    ...
                    className="hs-dropdown-menu hs-dropdown-open:opacity-100 transition-[opacity,margin] duration opacity-0 hidden z-10 mt-2 bg-white rounded-lg shadow-xl border border-gray-200 min-w-48"
                    role="menu"
                  ...
                  >
                    <div className="p-1">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-red-600 hover:bg-red-50 focus:outline-none"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
